...
The charts above have shown that uneven ground can give erronous magnitude but ver low standard deviation as it is steady state error. A sudden impact on the concentrator is enough to push the standard deviation over the expected value but due to the 10 second average it does not casue a dramatic increase in average magnitude. This resulted in the implementation of a double threshold system where both magnitude and standard deviation were required to be above their threshold value for the device to recognise the concentrator as on. Tests below show the success of this new system.
